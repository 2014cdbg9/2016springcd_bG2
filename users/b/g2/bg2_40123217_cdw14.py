...
b40123217_1 = Blueprint('b40123217_1', __name__, url_prefix='/b40123217_1', template_folder='templates')

@b40123217_1.route('/fourgear', defaults={'n1':15,'n2':20,'n3':18,'n4':20})
@b40123217_1.route('/fourgear/<n1>/<n2>/<n3>/<n4>')
